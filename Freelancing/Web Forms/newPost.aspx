<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newPost.aspx.cs" Inherits="Freelancing.Web_Forms.newPost" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="post-container">
        <h2 class="post-title">Make a post now!</h2>
          ...
          <asp:Button runat="server" ID="btnPost" CssClass="post-btn" Text="Post" OnClick="btnPost_Click" />
